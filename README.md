...
## 📂 Project Structure
- `/pages`: Portfolio pages managed by Next.js.
- `/components`: Reusable components.
- `/styles`: Styling files with TailwindCSS.
- `/public`: Static assets like images and fonts.

## 🚀 Features
- Showcase of my professional profile and experience.
- Projects section with details and repository links.
- Option to download my resume directly from the portfolio.
